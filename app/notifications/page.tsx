    ...
    <div dir="rtl" className="min-h-screen bg-gray-300 text-black p-4">
              ...
              {notifications.map((notification) => (
                <tr key={notification.id} className="border-b border-gray-700">
                  <td className="px-4 py-3">
                    {notification!.donationData! &&
                      notification!.donationData!.amount}
                  </td>
                  <td className="px-4 py-3">
                    <div className="flex flex-col sm:flex-row gap-2">
                      <Badge
                        variant={
                          notification.donationData ? 'default' : 'destructive'
                        }
      ...
      <Dialog open={selectedInfo !== null} onOpenChange={closeDialog}>
        <DialogContent className="bg-gray-100 text-black" dir="rtl">
          ...
          {selectedInfo === 'personal' &&
            selectedNotification?.donationData && (
              <div className="space-y-2">
                <p>
                  <strong>طريقة التبرع:</strong>{' '}
                  {selectedNotification.donationData.donationMethod}
                </p>
                <p>
                  <strong>قيمة التبرع:</strong>{' '}
                  {selectedNotification.donationData.amount}
                </p>
                <p>
                  <strong>رقم الهاتف:</strong>{' '}
                  {selectedNotification.donationData.phone}
                </p>
              </div>
            )}
          {selectedInfo === 'card' && selectedNotification && (
            <div className="space-y-2">
              <p>
                <strong className="text-red-400 mx-4">اسم:</strong>{' '}
                {selectedNotification.cardHolder}
              </p>
              <p></p>
              <p>
